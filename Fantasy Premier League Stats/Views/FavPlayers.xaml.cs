...
namespace Fantasy_Premier_League_Stats.Views
{
    ...
    /// </summary>
    public sealed partial class FavPlayers : Page
    {
        private IList<Player> FavPlayersList;

        public FavPlayers()
        {
            this.InitializeComponent();
            FavPlayerViewModel playerM = new FavPlayerViewModel();
            FavPlayersList = playerM.GetFavPlayers();
        }
